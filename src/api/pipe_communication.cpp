...
PipeCommunication::PipeCommunication(boost::asio::io_context& io_context,
...
void PipeCommunication::register_handler(const std::string& message_type, MessageHandler handler) {
    handlers_[message_type] = std::move(handler);
}

boost::asio::awaitable<void> PipeCommunication::send_message(const std::string& type,
...
boost::asio::awaitable<void> PipeCommunication::read_message_loop() {
...
boost::asio::awaitable<void> PipeCommunication::handle_message(const std::string& message_str) {
